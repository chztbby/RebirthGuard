...
CONST BYTE encrypted_api_name[][50]
{
	...
	{ 0xFF, 0xC8, 0xCC, 0xC9, 0xEB, 0xC4, 0xC1, 0xC8, 0xAD, }, // ReadFile
...
VOID DecryptXOR(CHAR* buffer, DWORD api_index)
{
	if (api_index >= sizeof(encrypted_api_name) / sizeof(PVOID))
		RG_Report(RG_ENABLE | RG_ENABLE_LOG | RG_ENABLE_POPUP | RG_ENABLE_KILL, REPORT_INVALID_APICALL, (PVOID)(SIZE_T)api_index, (PVOID)0);

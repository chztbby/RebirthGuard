...
#define RG_OPT_REBIRTH_SYSTEM_MODULES				(RG_DISABLE & !RG_OPT_COMPAT_VMPROTECT_STRIP_RELOCATION)
#define RG_OPT_REBIRTH_ALL_MODULES					(RG_DISABLE & !RG_OPT_COMPAT_VMPROTECT_STRIP_RELOCATION)
#define RG_OPT_SET_PROCESS_POLICY					(RG_DISABLE & !RG_OPT_COMPAT_VMPROTECT)	// EXE only
...
#define RG_OPT_DEALLOC_SUSPICIOUS_MEMORY			(RG_DISABLE) // fix..
